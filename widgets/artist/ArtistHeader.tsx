...
const ArtistHeader = ({ name, bio, artistImage, stats }: Props) => {
    return (
        <div className="pt-13.5 lg:pt-[108.09px] relative">
            ...
            <Container>
                <div className="absolute top-78.5 lg:top-92 z-1002">
                    <Image src={artistImage} width={120} height={120} alt="author image" className="rounded-[20px] overflow-hidden border border-bg" />
                </div>
                <div className="pb-10 pt-22.5">
                    <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                        <h1 className="text-[51px] font-semibold leading-[110%] mb-7.5 mв:mb-0 text-white">{name}</h1>
                        ...
                        <div className="mb-7.5">
                            <Stats {...stats} mobilePostion="start" />
                        </div>
                    </div>
                    <div className="mb-7.5">
                        <span className={`${spaceMomoSans.className} block text-lable-text mb-2.5`}>Bio</span>
                        <p className="text-white text-[22px] leading-[160%]">{bio}</p>
                    </div>
